...
fun PrivacyCard(
    ...
    CollapsibleSettingsCard(
        ...
        Text(
            text =
                if (blockUnknownSenders) {
                    stringResource(R.string.settings_privacy_enabled_description)
                } else {
                    stringResource(R.string.settings_privacy_disabled_description)
                },
        ...
        Row(
            ...
            Text(
                text = stringResource(R.string.settings_privacy_blocked_users),
                style = MaterialTheme.typography.bodyMedium,
                modifier =
                    Modifier
                        .weight(1f)

...
fun RNodeFlasherCard(
    ...
    CollapsibleSettingsCard(
        title = stringResource(R.string.rnode_flasher_title),
        ...
        // Description
        Text(
            text = stringResource(R.string.settings_rnode_flasher_description),
        ...
        Text(
            text = stringResource(R.string.settings_rnode_flasher_supported),
        ...
        Button(
            ...
            Text(stringResource(R.string.settings_rnode_flasher_open))
        }
    }
}

...
fun NetworkCard(
    ...
    CollapsibleSettingsCard(
        ...
        Text(
            text = stringResource(R.string.settings_network_status_description),
        ...
        Text(
            text =
                if (interfacesDisabled) {
                    stringResource(R.string.settings_network_interfaces_disabled_description)
                } else {
                    stringResource(R.string.settings_network_interfaces_description)
                },
            style = MaterialTheme.typography.bodyMedium,
            color =
                if (interfacesDisabled) {
        ...
        Row(
            ...
            Row(
                ...
                Text(
                    text = stringResource(R.string.settings_network_transport_node),
        ...
        Text(
            text = stringResource(R.string.settings_network_transport_node_description),
        ...
        Button(
            ...
            Text(stringResource(R.string.settings_network_view_status))
        }
        ...
        OutlinedButton(
            ...
            Spacer(modifier = Modifier.width(8.dp))
            Text(stringResource(R.string.settings_network_manage_interfaces))
        }
    }
}

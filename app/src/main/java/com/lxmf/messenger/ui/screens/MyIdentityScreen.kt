    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = stringResource(R.string.my_identity_display_name_title),
            ...
            // Description
            Text(
                text = stringResource(R.string.my_identity_display_name_description),
            ...
            OutlinedTextField(
                ...
                label = { Text(stringResource(R.string.my_identity_custom_display_name_label)) },
                placeholder = { Text(stringResource(R.string.my_identity_custom_display_name_placeholder)) },
                modifier = Modifier.fillMaxWidth(),
                singleLine = true,
                colors =
    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = stringResource(R.string.my_identity_profile_icon_title),
                    style = MaterialTheme.typography.titleMedium,
                    fontWeight = FontWeight.Bold,
                )
            }
            ...
            Text(
                text =
                    stringResource(R.string.my_identity_profile_icon_description),
                style = MaterialTheme.typography.bodyMedium,
                color = MaterialTheme.colorScheme.onSurfaceVariant,
            )
            ...
            Row(
                ...
                Column(
                    ...
                    Text(
                        text = if (iconName != null) stringResource(R.string.my_identity_custom_icon, iconName) else stringResource(R.string.my_identity_using_identicon),
                        style = MaterialTheme.typography.bodyMedium,
                        fontWeight = FontWeight.Medium,
                    )
                    Text(
                        text =
                            if (iconName != null) {
                                stringResource(R.string.my_identity_change_custom_icon_hint)
                            } else {
                                stringResource(R.string.my_identity_identicon_hint)
                            },
                        style = MaterialTheme.typography.bodySmall,
                        color = MaterialTheme.colorScheme.onSurfaceVariant,
                    )
...
private fun QrCodeQuickCard(
    ...
    val shareChooserTitle = stringResource(R.string.my_identity_share_chooser_title)
    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = stringResource(R.string.my_identity_share_identity_title),
                    style = MaterialTheme.typography.titleMedium,
                    fontWeight = FontWeight.Bold,
                )
            }
            ...
            Row(
                ...
                Button(
                    onClick = {
                        qrCodeData?.let { data ->
                            val shareText = context.getString(R.string.my_identity_share_text, displayName, data)
                            val sendIntent =
                                Intent().apply {
...
private fun AdvancedIdentityCard(
    ...
    Card(
        ...
        Column(
            ...
            TextButton(
                ...
                val toggleLabel = if (showAdvanced) stringResource(R.string.my_identity_hide_advanced) else stringResource(R.string.my_identity_show_advanced)
                Icon(
    ...
    if (showIdentityHashHelp) {
        AlertDialog(
            ...
            text = {
                Text(stringResource(R.string.my_identity_identity_hash_help_message))
            },
            confirmButton = {
    ...
    if (showDestinationHashHelp) {
        AlertDialog(
            ...
            text = {
                Text(stringResource(R.string.my_identity_destination_hash_help_message))
            },
            confirmButton = {
    ...
    if (showPublicKeyHelp) {
        AlertDialog(
            ...
            text = {
                Text(stringResource(R.string.my_identity_public_key_help_message))
            },
            confirmButton = {
        ...
        Row(
            ...
            IconButton(onClick = onCopy) {
                Icon(
                    ...
                    contentDescription = stringResource(R.string.my_identity_copy_value, label),
                    tint = MaterialTheme.colorScheme.primary,
                )
            }
        }
    ...
    androidx.compose.ui.window.Dialog(
        ...
        Surface(
            ...
            Scaffold(
                topBar = {
                    TopAppBar(
                        title = { Text(stringResource(R.string.my_identity_share_identity_title)) },
                        navigationIcon = {
                                ...
                                onClick = {
                                    qrCodeData?.let { data ->
                                        val shareText =
                                            if (destinationHash != null) {
                                                context.getString(
                                                    R.string.my_identity_full_share_text_with_destination,
                                                    displayName,
                                                    destinationHash,
                                                    data,
                                                )
                                                ...
                                                context.getString(
                                                    R.string.my_identity_full_share_text_without_destination,
                                                    displayName,
                                                    data,
                                                )
                                            }
                ...
                Column(
                    ...
                    if (qrCodeData != null) {
                        ...
                        Text(
                            text = stringResource(R.string.my_identity_scan_qr_to_add_me),
                            style = MaterialTheme.typography.bodyMedium,
                            color = MaterialTheme.colorScheme.onSurfaceVariant,
                        )
                    } else {

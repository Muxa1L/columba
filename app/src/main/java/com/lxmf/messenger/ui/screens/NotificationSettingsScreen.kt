            ...
            Column(
                ...
                Row(
                    ...
                    Icon(
                        ...
                        contentDescription = stringResource(R.string.notification_settings_notifications_cd),
                        tint = MaterialTheme.colorScheme.primary,
                    )
                    Text(
                        text = stringResource(R.string.notification_settings_enable_title),
...
fun NotificationTypesCard(
    ...
    Card(
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.notification_settings_types_subtitle),
                style = MaterialTheme.typography.bodyMedium,
                color = MaterialTheme.colorScheme.onSurfaceVariant,
            )
            ...
            NotificationTypeItem(
                ...
                title = stringResource(R.string.notification_settings_received_message_title),
            ...
            NotificationTypeItem(
                ...
                title = stringResource(R.string.notification_settings_saved_peer_title),
                description = stringResource(R.string.notification_settings_saved_peer_description),
                enabled = masterEnabled,
            ...
            NotificationTypeItem(
                ...
                title = stringResource(R.string.notification_settings_heard_announce_title),
            ...
            if (heardAnnounce) {
                NotificationTypeItem(
                    ...
                    title = stringResource(R.string.notification_settings_direct_only_title),
                ...
                NotificationTypeItem(
                    ...
                    title = stringResource(R.string.notification_settings_exclude_tcp_title),
            ...
            NotificationTypeItem(
                ...
                title = stringResource(R.string.notification_settings_ble_connected_title),
            ...
            NotificationTypeItem(
                ...
                title = stringResource(R.string.notification_settings_ble_disconnected_title),

...
private fun PermissionStatusRow(
    ...
    Row(
        ...
        Icon(
            ...
            contentDescription = if (granted) stringResource(R.string.settings_voice_call_permissions_granted) else stringResource(R.string.settings_voice_call_permissions_not_granted),
            tint = contentColor,

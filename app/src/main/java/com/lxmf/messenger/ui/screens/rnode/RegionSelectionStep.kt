...
fun RegionSelectionStep(viewModel: RNodeWizardViewModel) {
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.region_selection_description),
        ...
        LazyColumn(
            ...
            item {
                CustomSettingsCard(
                    title = stringResource(R.string.region_selection_custom_settings_title),
                    description = stringResource(R.string.region_selection_custom_settings_description),
                ...
                if (state.selectedCountry == null) {
                    ...
                    item {
                        OutlinedTextField(
                            ...
                            label = { Text(stringResource(R.string.region_selection_search_countries)) },
                        ...
                        Row(
                            ...
                            IconButton(onClick = { viewModel.selectCountry(null) }) {
                                Icon(
                                    ...
                                    contentDescription = stringResource(R.string.region_selection_back_to_countries),
                                )
                            }
                            Icon(
...
private fun PopularPresetsHeader(
    ...
    TextButton(
        ...
        Row(
            ...
            Text(
                text = stringResource(R.string.region_selection_popular_local_presets),

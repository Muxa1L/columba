...
private fun IntervalSelector(
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Text(
            text = pluralStringResource(R.plurals.auto_announce_interval_hours, intervalHours, intervalHours),
            style = MaterialTheme.typography.bodyMedium,
                ...
                label = {
                    Text(
                        if (presetIntervals.contains(intervalHours)) {
                            ...
                            stringResource(
                                R.string.auto_announce_custom_with_value,
                                stringResource(R.string.auto_announce_hours_short, intervalHours),
                            )
                        },
                    )
                },
        ...
        if (showManualAnnounceSuccess) {
            Row(
                ...
                Icon(
                    ...
                    contentDescription = stringResource(R.string.auto_announce_success),
                    tint = MaterialTheme.colorScheme.primary,
                    modifier = Modifier.size(16.dp),
                )
                Spacer(modifier = Modifier.width(4.dp))
                Text(
                    text = stringResource(R.string.auto_announce_sent),
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.primary,
                )
            }
        ...
        if (manualAnnounceError != null) {
            Row(
                ...
                Icon(
                    ...
                    contentDescription = stringResource(R.string.auto_announce_error),
                    tint = MaterialTheme.colorScheme.error,
                    modifier = Modifier.size(16.dp),
                )
                Spacer(modifier = Modifier.width(4.dp))
                Text(
                    text = stringResource(R.string.auto_announce_error_message, manualAnnounceError),
                    style = MaterialTheme.typography.bodySmall,
    ...
    AlertDialog(
        ...
        text = {
            Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                ...
                OutlinedTextField(
                    ...
                    label = { Text(stringResource(R.string.auto_announce_hours)) },
        ...
        confirmButton = {
            Button(
                ...
                Text(stringResource(R.string.auto_announce_confirm))
            }
        },
        dismissButton = {

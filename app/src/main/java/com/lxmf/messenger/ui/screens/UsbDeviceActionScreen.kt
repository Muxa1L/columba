...
fun UsbDeviceActionScreen(
    ...
    if (showDisableConfirmation) {
        AlertDialog(
            ...
            title = { Text(stringResource(R.string.usb_device_action_disable_transport_title)) },
            text = {
                Text(stringResource(R.string.usb_device_action_disable_transport_message))
            },
            confirmButton = {
                TextButton(
                    onClick = {
    ...
    if (isDisablingTransport) {
        AlertDialog(
            onDismissRequest = {},
            title = { Text(stringResource(R.string.usb_device_action_disabling_title)) },
            text = {
                Row(
                    ...
                    Text(stringResource(R.string.usb_device_action_disabling_message))
                }
            },
            confirmButton = {},
        )
    ...
    if (disableTransportResult != null) {
        AlertDialog(
            ...
            title = {
                Text(
                    if (disableTransportResult) {
                        stringResource(R.string.usb_device_action_disabled_title)
                    } else {
            ...
            text = {
                Text(
                    if (disableTransportResult) {
                        stringResource(R.string.usb_device_action_disabled_message)
                    } else {
                        stringResource(R.string.usb_device_action_disable_failed_message)
                    },
                )
            },
            confirmButton = {
    ...
    Scaffold(
        ...
        Column(
            ...
            ActionCard(
                ...
                title = stringResource(R.string.usb_device_action_disable_transport_card_title),
                description = stringResource(R.string.usb_device_action_disable_transport_card_description),

...
fun IdentityCard(
    ...
    CollapsibleSettingsCard(
        ...
        Text(
            text = stringResource(R.string.settings_identity_description_primary),
        ...
        Text(
            text = stringResource(R.string.settings_identity_description_secondary),
            style = MaterialTheme.typography.bodyMedium,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
        )
        ...
        Button(
            ...
            Text(stringResource(R.string.settings_identity_view_my_identity))
        }
        ...
        OutlinedButton(
            ...
            Spacer(modifier = Modifier.width(8.dp))
            Text(stringResource(R.string.settings_identity_manage_identities))
        }
    }
}

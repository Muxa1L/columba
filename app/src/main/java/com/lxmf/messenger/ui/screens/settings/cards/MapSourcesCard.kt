...
fun MapSourcesCard(
    ...
    CollapsibleSettingsCard(
        ...
        // Description
        Text(
            text = stringResource(R.string.settings_map_sources_description),
            style = MaterialTheme.typography.bodyMedium,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
        )

        Text(
            text = stringResource(R.string.settings_map_sources_sources),
        ...
        // HTTP source toggle
        MapSourceToggle(
            title = stringResource(R.string.settings_map_sources_http_title),
            description = stringResource(R.string.settings_map_sources_http_description),
            enabled = httpEnabled,
        ...
        if (RMSP_FEATURE_ENABLED) {
            MapSourceToggle(
                title = stringResource(R.string.settings_map_sources_rmsp_title),
                description =
                    if (rmspServerCount > 0) {
                        stringResource(R.string.settings_map_sources_rmsp_servers_available, rmspServerCount)
                    } else {
                        stringResource(R.string.settings_map_sources_rmsp_description)
                    },
                enabled = rmspEnabled,
                onEnabledChange = { enabled ->
        ...
        Text(
            text = stringResource(R.string.settings_map_sources_settings),
            style = MaterialTheme.typography.labelLarge,
            fontWeight = FontWeight.SemiBold,
            color = MaterialTheme.colorScheme.onSurface,
            modifier = Modifier.padding(top = 8.dp),
        ...
        MapSourceToggle(
            title = stringResource(R.string.settings_map_sources_marker_declutter_title),
            description = stringResource(R.string.settings_map_sources_marker_declutter_description),
        ...
        if (showWarning) {
            Row(
                ...
                Text(
                    text = stringResource(R.string.settings_map_sources_no_sources_warning),
        ...
        if (hasOfflineMaps) {
            Text(
                text = stringResource(R.string.settings_map_sources_offline_maps_available),
                style = MaterialTheme.typography.bodySmall,
